...
<body>
    ...
    <asp:Panel ID="Panel2" runat="server" BackColor="#9999FF" Height="122px" 
        Width="1500px">
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
    ...
    longdesc="http://localhost:1668/Hotel Management System/Images/staff3.png" 
    src="Images/log.png" />&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="HyperLink5" runat="server" 
            Font-Bold="True" Font-Italic="False" Font-Names="britannic bold,16.2pt,x-large" 
    ...
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="~/Images/j4.jpg" 
